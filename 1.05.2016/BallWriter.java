...
public class BallWriter 
{
   ...
   public void paint(Graphics g)
   {
      ...
      g.drawOval(ball.xPosition() - radius, ball.yPosition() - radius, radius * 2, radius * 2);
      ...
      g.setColor(Color.black);
      g.drawOval(ball1.xPosition() - radius1, ball1.yPosition() - radius1, (radius1) * 2, (radius1) * 2);
